...
def get_optimal_route(
    request_body: schemas.ProductListRequest, db: Session = Depends(get_db)
):
    """
    ...
    location_list = list(set([location for (id, location) in db_products_data])) + [start_node, 'E1'] 
    ...
    plot_ai_solution(ai_path_labels=ai_result,
                     full_graph_pkl_path=full_graph_path,
                     background_image_path=bk_img_path,
    ...
    return schemas.RouteResponse(
        ordered_product_ids=final_ordered_list,
